...
SCRIPTS = [
    ...
    "risk_assessment.py",    # 1st pass: scores + ΔT with default coefficients
    "uhi_calibration.py",    # reads scores, writes calibrated α/β to the graph
    "risk_assessment.py",    # 2nd pass: re-applies ΔT with the calibrated α/β
    "subzone_grid.py",       # 100 m grid-cell scoring written as uhi:GridCell
    "queries_and_viz.py",
]
